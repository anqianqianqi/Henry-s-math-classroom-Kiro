...
If the prompt includes "Corner instructions:" — follow them exactly per corner:
- "KEEP CLEAN AND EMPTY": that corner must have NO objects drawn on it — bare cover surface only, no decoration. Animated objects will be composited on top afterward.
- "render decorative objects baked into the cover surface": that corner should have the listed decorative objects rendered directly as part of the cover material.
