...
const SYSTEM = [
  ...
  '',
  'The box is the handwriting only: start just BELOW the bordered problem card',
  'and stop ABOVE the footer URL. Never include the printed card or the',
  'question inside it. Include every line of working and any diagram, number',
  'line or sketch that belongs to it. Prefer a box slightly too large over one',
  'that clips a line. If a sheet has the card but nothing handwritten under',
  'it, that problem was not answered.',
  '',
  'Report the box as fractions of the WHOLE image, origin at the top left:',
  'x and y are the left and top edges, w and h the width and height, 0 to 1.',
  'For a sheet on the right half of a two-up scan, x will be around 0.5.',
  '',
