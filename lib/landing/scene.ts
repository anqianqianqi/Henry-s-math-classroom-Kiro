...
export const landingTheme: LandingTheme = {
  ...
  assets: [
    ...
    { kind: 'fish', top: '16%', delay: '-1.7s', speed: '23s', scale: 0.72, color: '#ffbc4b' },
    { kind: 'fish', top: '38%', delay: '-17.4s', speed: '31s', scale: 0.96, color: '#ff7a7a' },
    { kind: 'fish', top: '58%', delay: '-8.6s', speed: '27s', scale: 0.64, color: '#8fe6d2' },
