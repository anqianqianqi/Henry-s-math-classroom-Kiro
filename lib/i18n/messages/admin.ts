...
export const admin = {
  ...
  'manga.chooseRenderMode': { en: 'How should we generate the panel art?', zh: '这次要怎样生成分格插画？' },
  'manga.renderModeHelp': { en: 'Every image is one text-free panel. Choose whether to review each prompt or run all approved panel prompts together.', zh: '每张图片都只生成一个无文字分格。请选择逐格检查，或一次运行所有已批准的分格提示词。' },
  'manga.oneByOne': { en: 'One by one', zh: '逐格生成' },
  'manga.oneByOneHelp': { en: 'Generate or revise one selected panel at a time.', zh: '每次只生成或修改一个指定分格。' },
  'manga.bulk': { en: 'Generate approved panels in bulk', zh: '批量生成已批准分格' },
  'manga.bulkHelp': { en: 'Run every pending panel prompt; each panel remains a separate image call.', zh: '运行所有待生成提示词，但每个分格仍然是一次独立图片调用。' },
  'manga.panelArt': { en: 'Panel artwork', zh: '分格插画' },
  'manga.bulkActive': { en: 'Bulk scheduling is active; panels are still generated separately.', zh: '当前为批量调度；每个分格依然单独生成。' },
  'manga.oneByOneActive': { en: 'Choose a panel to generate or revise.', zh: '请选择一个分格生成或修改。' },
  'manga.generatePending': { en: 'Generate all pending panels', zh: '生成所有待处理分格' },
  'manga.panel': { en: 'Panel', zh: '分格' },
  'manga.generatePanel': { en: 'Generate panel', zh: '生成这一格' },
  'manga.regeneratePanel': { en: 'Regenerate panel', zh: '重新生成这一格' },
