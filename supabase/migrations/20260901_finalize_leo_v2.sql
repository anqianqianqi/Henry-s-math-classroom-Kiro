...
(
  ...
  jsonb_build_object(
    'name', 'Leo / 乐欧',
    'classroomRole', 'The quiet student thinker who discovers patterns, explains meaning and verifies F-Bao’s deterministic output.',
    ...
    'underPressure', 'Lists the possibilities on his tablet, then tests inputs with F-Bao until the pattern is clear.',
    ...
    'signatureActions', jsonb_build_array(
      ...
      'offers F-Bao an input, crouches to the same eye level and observes the chest chamber',
      'smiles warmly and draws a diagram when explaining why F-Bao’s answer works'
    ),
    'relationshipWithHanbao', 'Leo treats F-Bao as a partner. F-Bao executes the function correctly; Leo discovers, verifies and explains why the mapping works.',
