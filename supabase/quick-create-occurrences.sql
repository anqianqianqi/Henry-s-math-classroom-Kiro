-- Quick Create Mock Occurrences
-- This will automatically create occurrences for the teacher's most recent class
...
-- Create occurrences for the most recent class
...
WHERE co.class_id = (SELECT id FROM classes ORDER BY created_at DESC LIMIT 1)
