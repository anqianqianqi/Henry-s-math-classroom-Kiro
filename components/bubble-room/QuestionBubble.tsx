      ...
      >
        ...
        <div
          className={`
            ...
            ${question.challenge_id
              ? 'shadow-[inset_0_0_0_1.5px_rgba(255,200,100,0.45),inset_-3px_-3px_6px_rgba(200,120,0,0.25)]'
        ...
        <div
          ...
          style={{
            ...
            background: question.challenge_id
              ? 'linear-gradient(to bottom, transparent, rgba(180,80,0,0.15))'
        ...
        {/* Challenge link */}
        {question.challenge_id && (
          <div className="mt-0.5 text-[9px] font-semibold text-amber-700 flex items-center gap-0.5 relative z-10">
