...
export default function SessionsList({ classId, onSelectSession }: SessionsListProps) {
  ...
  async function loadOccurrences() {
    try {
      ...
      // No auto-generation. Sessions are authored on the dashboard calendar
      // now, and a list that quietly put back what a teacher had just deleted
      // would undo them from a different screen.
      setOccurrences(data || [])
    } catch (err) {
